...
- Name: health.spec.js >> Health Management >> should display medical pharmacy panel
- Location: tests\health.spec.js:4:3
...
Locator: locator('h1')
Expected substring: "Medical Pharmacy Panel"
Received string:    "Welcome Back"

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('h1')
    8 × locator resolved to <h1>…</h1>
