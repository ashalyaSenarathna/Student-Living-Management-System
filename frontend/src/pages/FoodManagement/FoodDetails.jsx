...
const FoodDetails = () => {
    ...
    return (
        <div className="fd-page">
            ...
            <div
                className="fd-hero"
                style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.55), rgba(6,10,31,1)), url(${restaurant.image || 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=1200&q=80'})` }}
            >
